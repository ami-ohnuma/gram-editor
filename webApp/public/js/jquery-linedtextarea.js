...
(function ($) {
	...
	$.fn.linedtextarea = function (options) {
		...
		return this.each(function () {
			...
			var linedTextAreaDiv = textarea.parent().wrap("<div class='form-control  br0 border-color-black linedwrap pRt66 h180' style='width:" + originalTextAreaWidth + "px'></div>");
			var linedWrapDiv = linedTextAreaDiv.parent();

			linedWrapDiv.prepend("<div class='lines pTb50' style='width:50px'></div>");
